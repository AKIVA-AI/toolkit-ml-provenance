"""
Control-plane adapter for toolkit-ml-provenance.
...
Toolkit-ml-provenance is an Archetype 9 CLI tool (TK-MP).  The control-plane
contract here covers:
  - Config hierarchy (global defaults -> toolkit config -> CLI overrides)
  - CLI command -> ToolSpec mapping for generate, keygen, sign, verify
